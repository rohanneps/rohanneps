...
#     }
# }
REST_SERVER_HOST_ADDRESS ='157.230.62.186'          # server where the mysql database, redis server and elasticsearch exists
...
LOGGER_LIST = ['project','core','helpers','search','client','download']
...
PROJECT_INPUT_FOLDER = os.path.join(BASE_DIR,'input')               # folder where the input file is collected for all projects
PROJECT_INPUT_FILE_PATTERN = '{}.{}'

helper.create_dir(PROJECT_INPUT_FOLDER)

PROJECT_PROCESS_INPUT_FOLDER = 'input'
...
PROJECT_DOWNLOAD_FOLDER = os.path.join(BASE_DIR,'downloadables')
PROJECT_DOWNLOAD_FILE = 'human_verdict_match_{}.tsv'
helper.create_dir(PROJECT_DOWNLOAD_FOLDER)
...
# CELERY_BROKER_URL = 'redis://192.168.15.28'     # replace 192.168.15.28 with ur ip or localhost
# CELERY_RESULT_BACKEND = 'redis://192.168.15.28:6379'

CELERY_BROKER_URL = 'redis://{}'.format(REST_SERVER_HOST_ADDRESS)
CELERY_RESULT_BACKEND = 'redis://{}:6379'.format(REST_SERVER_HOST_ADDRESS)
...
# FTP HEADERS
FTP_LOCATION = REST_SERVER_HOST_ADDRESS
FTP_USER = 'root'
FTP_KEY_PATH = '/media/rohan/media/February/elastic_server/es_server.pem'
FTP_ROOT_FOLDER_LOCATION = '/var/www/productmatch_webservice/rest_image_match_server/input'
FTP_TIMEOUT = 100
##############################################################################
...
ES_HOST = REST_SERVER_HOST_ADDRESS
ES_PORT = 9200
ES_COMPUTED_RESULT_INDEX = 'dmap_product_match'
...
DOWNLOAD_HEADERS = ["s_sku","r_product_url","human_verdict"]
##############################################################################